// Official Keyrus wordmark, traced from the brand SVG served on keyrus.com.
// The "k" icon keeps its fixed brand colors; the "eyrus" letters use
// currentColor so the mark adapts to light/dark theme via CSS `color`.

export function KeyrusMark({ className, title = "Keyrus" }) {
  return (
    <svg
      className={className}
      viewBox="0 0 67 20"
    ...
    >
      <defs>
        <linearGradient id="keyrusBarGradient" x1="50%" y1="0%" x2="50%" y2="100%">
          <stop offset="0%" stopColor="#25C6FF" />
          <stop offset="100%" stopColor="#2ED0FF" />
        </linearGradient>
      </defs>
